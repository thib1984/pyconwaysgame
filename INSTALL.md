...
```
pip3 uninstall pyconwaysgame
pip uninstall pyconwaysgame
pip3 uninstall pyconwaysgame --break-system-packages
pip uninstall pyconwaysgame --break-system-packages
```
