...
To contribute, it's simple, check the [existing issues](https://github.com/thib1984/pyconwaysgame/issues). If you see an issue you are interested to work, please let a message and i assign you the task. With this, all people know you are working on this issue.
...
git clone https://github.com/thib1984/pyconwaysgame.git
...
rm -rf pyconwaysgame_env 

# Create a virtual environment to isolate dependencies for this project
python3 -m venv pyconwaysgame_env
source pyconwaysgame_env/bin/activate
